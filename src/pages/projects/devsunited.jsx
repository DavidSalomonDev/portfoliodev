...
const Project = () => {
  return (
    <Layout title="Devs United">
      <Container>
        <Title>
          Devs United <Badge>2021</Badge>
        </Title>

        <Paragraph>
          The challenge is to create an entire web application, focusing on the
          front end and without the need to code the back end. Data
          visualization while incorporating graphics libraries made with React.
        </Paragraph>
        <List ml={4} my={4}>
          <ListItem>
            <Meta>Website</Meta>
        ...
        <ProjectImage
          src="/images/projects/devsunited -1.png"
          alt="Devs United"
        />
        <ProjectImage
          src="/images/projects/devsunited -2.png"
          alt="Devs United"
        />
      </Container>
    </Layout>
