        ...
        <SimpleGrid columns={[1, 1, 2]} gap={6}>
          <Section delay={0.2}>
            <ProjectGridItem
              id="devsunited"
              title="Devs United"
              thumbnail={devsunited}
            >
              A twitter clone, a full stack application. Users can create their
              account, pick a username and a favorite color, make posts and like
              others&apos; posts.
            </ProjectGridItem>
          </Section>
          <Section delay={0.4}>
            <ProjectGridItem
              ...
              thumbnail={hotels}
            >
              An application for the frontend to make reservations, you can
              filter out hotels by price, size, location and availability.
            </ProjectGridItem>
          </Section>
          <Section delay={0.6}>
            <ProjectGridItem
              ...
              thumbnail={JSprojects}
            >
              50 vanilla Javascript projects in 50 days, where DOM manipulation
              is the king.
            </ProjectGridItem>
          </Section>
          <Section delay={0.8}>
